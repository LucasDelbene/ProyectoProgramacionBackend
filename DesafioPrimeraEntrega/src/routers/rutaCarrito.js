...
const {getAllProductsByIdCart, crearCarrito, addProduct, deleteCartById, deleteProductById} = require("../controller/carritoController");

const rutaCarrito = Router();

//IMPLEMENTANDO RUTAS//
rutaCarrito.get(`/:id/productos`, getAllProductsByIdCart);        //ME PERMITE LISTAR TODOS LOS PRODUCTOS GUARDADOS EN EL CARRITO//
rutaCarrito.post(`/`, crearCarrito);                              //CREA UN CARRITO Y DEVUELVE SU ID//
