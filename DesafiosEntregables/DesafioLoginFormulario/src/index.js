//DESAFIO ENTREGABLE - LOGIN FORMULARIO//
...
//RUTA 'api/productos-test' CON METODO GET//
ruta.get('/api/productos-test', (peticion, respuesta) => {
    const user = peticion.query.nameLogin;
    peticion.session.usuario = user;

    const dataRandom = [];
    const data = {
        dataRandom: dataRandom,
        nameLogin: peticion.session.usuario
    };
