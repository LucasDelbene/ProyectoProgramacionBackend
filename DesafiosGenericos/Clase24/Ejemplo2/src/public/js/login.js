...
formulario.addEventListener('submit', evt=>{
    evt.preventDefault();                         //LLAMO A preventDefault() DURANTE LA EJECUCION, PARA CANCELAR EL EVENTO
    ...
    fetch('/api/sessions/login', {               //HAGO UN fetch() e INDICO LO SIGUIENTE EN LA RUTA '/api/sessions/login'
