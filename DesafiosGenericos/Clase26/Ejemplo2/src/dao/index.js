...
switch(persistencia) {
    case 'MONGO':
        ...
        const connection = mongoose.connect("mongodb+srv://LucasDelbene:776@clase24-programacionbac.13mdabl.mongodb.net/Clase26(Ejemplo2)?retryWrites=true&w=majority");
